    ...
    SHOW_NOTIFICATION("Sample Notification", null) {
      @Override public void launch(Activity activity) {
        RemoteViews remoteViews =
            new RemoteViews(activity.getPackageName(), R.layout.sample_widget);

        NotificationCompat.Builder builder =
            new NotificationCompat.Builder(activity).setSmallIcon(R.drawable.icon)
                .setContentText(activity.getString(R.string.sample_notification_text))
                .setContentTitle(activity.getString(R.string.sample_notification))
        ...
        Picasso.with(activity) //
            ...
            .resizeDimen(R.dimen.notification_icon_width, R.dimen.notification_icon_height) //
            .into(remoteViews, R.id.image, NOTIFICATION_ID, notification);
      }
    };
